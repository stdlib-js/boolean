...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/boolean@v0.0.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Boolean } from 'https://cdn.jsdelivr.net/gh/stdlib-js/boolean@v0.0.1-esm/index.mjs';
```
