...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/boolean@v0.3.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/boolean/actions/workflows/test.yml/badge.svg?branch=v0.3.3
[test-url]: https://github.com/stdlib-js/boolean/actions/workflows/test.yml?query=branch:v0.3.3
